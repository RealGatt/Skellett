...
public class ExprMySQLUsername extends SimpleExpression<String> {
    ...
    protected String[] get(Event e) {
        return new String[]{Skellett.getInstance().getMysqlData().getString("MySQLSetup.Username")};
    }

    @Override
    public void change(Event e, Object[] delta, Changer.ChangeMode mode) {
        if (mode == ChangeMode.SET) {
            Skellett.getInstance().getMysqlData().set("MySQLSetup.Username", (String) delta[0]);
        }
    }
